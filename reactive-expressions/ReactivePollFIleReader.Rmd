---
title: "reactivePoll and reactiveFileReader"
output: 
...
This app has a log file which is appended to",
        "every second.  

```{r}
# R:\r-shiny\shiny-mini-apps\shiny-rstudio\059-reactive-poll-and-file-reader
